...
class PHPlot {
    ...
    protected static $datatypes_map = array( // For backward compatiblity or aliases, see SetDataType()
    ...
    protected static $plots = array( // Table of plot types
        'area' => array(
    ...
    public $data_value_label_angle = 90; // Calculated default
    ...
    public $pie_min_size_factor = 0.5; // Deprecated - Use the 'suffix' argument to Set[XY]LabelType instead.
    ...
    protected $draw_data_borders; // Should be protected, but public for possible callback use
    ...
    protected $error_bar_line_width = 1; // Should be protected, but public to reduce breakage
...
,
    ...
    function DrawMessage($text, $options = NULL)
    {
        ...
        extract(array_merge(array(
            ...
            'wrap_width' => 75
        ) // Width in characters for wordwrap()
            , ( array )$options));
